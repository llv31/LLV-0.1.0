...
var nicEditorConfig = bkClass.extend({
    buttons:{
        ...
        'italic':{name:__('Click to Italic'), command:'Italic', tags:['EM', 'Iz'], css:{'font-style':'italic'}, key:'i'},
...
//        'hr' : {name : __('Horizontal Rule'), command : 'insertHorizontalRule', noActive : true}
    ...
    buttonList:['save', 'bold', 'italic', 'underline', 'left', 'center', 'right', 'justify', 'ol', 'ul', 'fontSize', 'fontFamily', 'fontFormat', 'indent', 'outdent', 'image', 'upload', 'link', 'unlink', 'forecolor', 'bgcolor', 'removeformat', 'xhtml'],
...
var nicEditorInstance = bkClass.extend({isSelected:false, construct:function (G, D, C) {
    ...
    if (H || this.options.hasPanel) {
        ...
        var A = new bkElement("DIV").setStyle({width:(newX - 8) + "px", padding:"4px", minHeight:newY + "px"}).addClass("main").appendTo(this.editorContain);
